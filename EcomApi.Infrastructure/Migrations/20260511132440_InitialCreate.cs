    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "High performance laptop", "Laptop", 75000.0, 10 },
                    { 2, 1, "Latest smartphone", "Phone", 25000.0, 25 },
                    { 3, 1, "Noise cancelling", "Headphones", 3000.0, 50 },
                    { 4, 2, "Wooden office desk", "Desk", 12000.0, 8 },
                    { 5, 2, "Ergonomic office chair", "Chair", 8000.0, 15 },
                    { 6, 3, "A5 ruled notebook", "Notebook", 200.0, 100 },
                    { 7, 3, "Ball point pen", "Pen", 50.0, 500 }
                });
